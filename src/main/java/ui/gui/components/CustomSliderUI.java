...
//            g.setColor(new Color(246, 146, 36));
    ...
    private Color determineColor() {
        ...
        if (healthBar.getCurrentHealth() > (int) (healthBar.getMaxHealth() * .60)) {
            return new Color(0, 209, 49);
        }
        if (healthBar.getCurrentHealth() > (int) (healthBar.getMaxHealth() * .30)) {
            return new Color(224, 243, 55);
        }
        return Color.RED;
    }
}
